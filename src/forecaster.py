...
class SiloForecaster:
    def __init__(self, df_sensores, linhagem_folder, reports_folder):
    ...
    def run_forecast(self, aviario_selecionado, data_alojamento, linhagem, n_aves):
        ...
        try:
            ...
            report_string, plot_fig = self._generate_report_and_plot()
            
            self.report_string = report_string
            self.plot_fig = plot_fig
            
            return report_string, plot_fig
    ...
    def _project_autonomy(self):
        ...
        for hora in range(1, 24 * 30): # Projeta para 30 dias
            ...
            # Projetar o consumo futuro em kg/hora
            # (consumo da tabela por ave por dia / 1000 g/kg / 24 horas/dia) * n_aves * fator_consumo
    ...
    def _generate_report_and_plot(self):
        ...
        ax.plot(self.df_hourly['peso_silo'], label=f'Histórico - Aviário {self.aviario_selecionado}')
        ...
        return final_report_string, fig